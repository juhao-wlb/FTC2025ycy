...
import org.firstinspires.ftc.teamcode.lib.roadrunner.trajectorysequence.sequencesegment.SequenceSegment;
import org.firstinspires.ftc.teamcode.lib.roadrunner.trajectorysequence.sequencesegment.TrajectorySegment;
  ...
  public @Nullable DriveSignal update(Pose2d poseEstimate, Pose2d poseVelocity) {
    ...
    if (currentTrajectorySequence != null) {
      ...
      if (currentSegment instanceof TrajectorySegment) {
        ...
        driveSignal =
            new DriveSignal(
                new Pose2d(0, 0, targetOmega + correction), new Pose2d(0, 0, targetAlpha));
      ...
      for (int i = 0; i < sequence.size(); i++) {
        ...
        if (segment instanceof TrajectorySegment) {
          ...
          DashboardUtil.drawSampledPath(
              fieldOverlay, ((TrajectorySegment) segment).getTrajectory().getPath());
