...
/**
 * This routine is designed to calculate the maximum angular velocity your bot can achieve under
 * load.
 *
 * <p>Upon pressing start, your bot will turn at max power for RUNTIME seconds.
 *
...
public class MaxAngularVeloTuner extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    telemetry.addData(
        "Max Recommended Angular Velocity (deg)", Math.toDegrees(maxAngVelocity * 0.8));
    telemetry.update();
