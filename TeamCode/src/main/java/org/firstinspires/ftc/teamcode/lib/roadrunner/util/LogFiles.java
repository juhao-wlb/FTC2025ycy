package org.firstinspires.ftc.teamcode.lib.roadrunner.util;
...
import org.firstinspires.ftc.teamcode.lib.roadrunner.drive.SampleTankDrive;
          ...
          if (!(opMode instanceof OpModeManagerImpl.DefaultOpMode)) {
            ...
            try {
              ...
              RobotLog.setGlobalErrorMsg(
                  new RuntimeException(e), "Unable to write data to " + file.getAbsolutePath());
            }
          }
        }
      };
    ...
    manager.register(
        ...
        session -> {
          ...
          return NanoHTTPD.newFixedLengthResponse(
              NanoHTTPD.Response.Status.OK, NanoHTTPD.MIME_HTML, sb.toString());
        });
    ...
    manager.register(
        ...
        session -> {
          ...
          return NanoHTTPD.newChunkedResponse(
              NanoHTTPD.Response.Status.OK, "application/json", new FileInputStream(f));
        });
  }
}
